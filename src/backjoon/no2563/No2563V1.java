...
public class No2563V1 {
    ...
    public static void main(String[] args) {
        ...
        int col = 100;
        int inputLocNum = 2;
        char[][] whitePaper = new char[row][col];
        ...
        // 색종이 위치 입력받기
        int[][] paperLoc = new int[paperNum][inputLocNum];
        for (int i = 0; i < paperNum; i++) {
            for (int j = 0; j < inputLocNum; j++) {
        ...
        for (int i = 0; i < paperNum; i++) {
            int left = paperLoc[i][0];
            int bottom = paperLoc[i][1];
