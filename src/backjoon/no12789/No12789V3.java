...
public class No12789V3 {
    public static void main(String[] args) {
        ...
        printResult(processStudent(currentNum, n, standing, stack));
    }
    ...
    private static boolean processStudent(int currentNum, int n, Deque<Integer> standing, Deque<Integer> stack) {
        while (true) {
            if (currentNum > n) {
                return true;
            }
